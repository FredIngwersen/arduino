...
/**********************************************************/
char array1[]="Adam er en dum jew, ew!                      ";  //the string to print on the LCD
char array2[]="Jeg er klog kylling, nam!                      ";  //the string to print on the LCD
...
void loop() 
{
  ...
  for (int positionCounter1 = 0; positionCounter1 < 38; positionCounter1++)
  {
